        ...
        getStocks((err, data) => {	
            ...
            const stocksInfo = data;	
             ...
             const Denis = new Profile({	
                username: 'denis',	
                name: { firstName: 'Denis', lastName: 'Bolbeko' },	
                password: 'bolbeko123',	
            });	
             ...
             Ivan.create((err, data) => {	
                if (err) {	
                    ...
                    console.log('Ivan is created!');	
                     ...
                     Denis.create((err, data) => {	
                        if (err) {	
                            console.error('Error during creating Denis');	
                            throw err;	
                        } else {	
                            console.log('Denis is created!');	
                                                            ...
                                                            Ivan.transferMoney(	
                                                                ...
                                                                (err, data) => {	
                                                                    if (err) {	
                                                                        ...
                                                                        console.log(	
                                                                            `Denis has got ${targetAmount} NETCOINS`	
                                                                        );	
                                                                    }	
                                                                }	
                                                            );	
